...
func TestSerienstreamEpisodeParse(t *testing.T) {
	...
	for _, v := range files {
		...
		episodes, err := serienstream.ParseEpisodes(string(content))
		if err != nil {
...
var sampleSeasons []model.Season = []model.Season{
	{
		Name:        "Breaking Bad",
		Href:        "/serie/breaking-bad/staffel-1",
		SeasonNum:   "01",
		SeasonLabel: "Staffel 1",
	},
	{
		Name:        "Squid Game",
		Href:        "/serie/squid-game/staffel-1",
		SeasonNum:   "01",
		SeasonLabel: "Staffel 1",
	},
	{
		Name:        "Fallout",
		Href:        "/serie/fallout/staffel-1",
		SeasonNum:   "01",
		SeasonLabel: "Staffel 1",
	},
}

func TestSerienstreamEpisodeLive(t *testing.T) {
